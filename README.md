...
docs/           ← decisions, open questions, DEFINITION-OF-DONE.md, ACCESSIBILITY.md
...
| **Solo build** | work on `main` | No teammates in the repo, so branch-per-screen was dropped as pure overhead. Branch only for something genuinely risky. |
